...
% Workshop-specific footer text, exactly as requested by the AI4Math
% chairs in the camera-ready email. (\ICML@appearing contains '@', so
% the redefinition must live inside \makeatletter...\makeatother.)
\makeatletter
\renewcommand{\ICML@appearing}{The \textit{$\mathit{3}^{rd}$ AI for Math Workshop} at the $\mathrm{43}^{rd}$
